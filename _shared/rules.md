...
- The configured CRM is the record of business state. Sent mail and drafts are established by the mail provider. Local review files track a run, never replace either system.
